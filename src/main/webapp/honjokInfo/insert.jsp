...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/app/resources/css/hojokinfo/insert.css">
...
<body>
    ...
    <script>
        ...
        function displayPlaces(places) {
            ...
            var listEl = document.getElementById('placesList'), menuEl = document.getElementById('menu_wrap'), fragment = document.createDocumentFragment(), 
